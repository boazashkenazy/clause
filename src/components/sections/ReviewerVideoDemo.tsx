...
const ReviewerVideoDemo: React.FC = () => {
      ...
      <Container>
        ...
        >
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            See Playbook Review in Action
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-600">
            Watch how Playbook Review turns hours of manual contract review into seconds with automated, policy-driven redlines.
          </p>
        </motion.div>
...
export default ReviewerVideoDemo;