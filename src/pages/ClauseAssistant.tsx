...
import AssistantFeatures from '../components/sections/AssistantFeatures';
          ...
          <div className="pb-20 pt-16 lg:pt-24">
            <div className="grid gap-12 lg:grid-cols-5 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-2">
                ...
                >
                  Your AI copilot for contract drafting. Generate precise language, identify risks, and access your proven clauses—all without leaving Microsoft Word.
                </motion.p>
                <motion.div
              ...
              >
                <div className="relative aspect-video overflow-hidden rounded-xl bg-gray-100 shadow-2xl border border-gray-200">
                  {showVideo ? (
                    ...
                    >
                      <source src="/images/drafting_assistant_video.mp4" type="video/mp4" />
                      Your browser does not support the video tag.
                    </video>
                  ) : (
                    <div className="relative cursor-pointer group h-full w-full" onClick={toggleVideo}>
                      <img
                        src="/images/drafting_assistant_thumbnail.png"
                        alt="Drafting Assistant demo preview"
                        className="h-full w-full object-cover"
                      />
