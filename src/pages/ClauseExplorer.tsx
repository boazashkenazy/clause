...
import ExplorerFeatures from '../components/sections/ExplorerFeatures';
          ...
          <div className="pb-20 pt-16 lg:pt-24">
            <div className="grid gap-12 lg:grid-cols-5 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-2">
                ...
                >
                  Make every contract in your library instantly searchable. Get cited answers, save your best clauses, and build reusable collections for drafting.
                </motion.p>
                <motion.div
                ...
                <div className="relative aspect-video overflow-hidden rounded-xl bg-gray-100 shadow-2xl border border-gray-200">
                  {showVideo ? (
                    ...
                    <div className="relative cursor-pointer group h-full w-full" onClick={toggleVideo}>
                      <img
                        src="/images/explorer_thumbnail.png"
                        alt="Explorer demo preview"
                        className="h-full w-full object-cover"
                      />
